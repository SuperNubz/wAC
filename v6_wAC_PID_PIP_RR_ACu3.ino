...
//         Serial.println(pressureValue);
      ...
      if (inHome == 0) //ensuring that assist control feature is available throughout the duration of inHome == 0 / exhale phase
      {
        ...
        if (assistSwitchState == true) 
        {
         ...
         Serial.print("Pressure: "); Serial.print(pressureValue); Serial.print("  |   ");
         Serial.print("Prev Pressure: "); Serial.print(previousPressureValue); Serial.print("   |   ");
         Serial.print("inv Sens");  Serial.print(invertedSensitivity); Serial.print("   |   ");
         Serial.println(previousPressureValue - 5 + invertedSensitivity);
